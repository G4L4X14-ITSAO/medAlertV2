...
MedAlert is a Next.js 14 App Router project for patient, doctor, and admin clinical monitoring.

## Setup

1. Run `npm install`.
2. Copy `.env.local.example` to `.env.local` and fill in your Supabase and Resend values.
3. Run `npm run dev`.
...
- `/auth/login`
- `/auth/profile-select`
- `/auth/verify-professional`
- `/dashboard`
- `/dashboard/medications`
- `/dashboard/medications/add`
- `/dashboard/signos`
- `/dashboard/signos/history`
- `/doctor/dashboard`
- `/doctor/patients`
- `/doctor/patient/[id]`
- `/doctor/patient/[id]/botiquin`
- `/admin/dashboard`
- `/admin/doctors/[id]/review`
- `/profile`
- `/unauthorized`
